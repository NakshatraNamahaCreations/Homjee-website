...
import { FaPhoneAlt, FaMapMarkerAlt, FaClock, FaEdit, FaCreditCard } from 'react-icons/fa';
import SlotSelectionModal from './SlotSelectionModal';
import AddressModal from './AddressModal';

const Checkout = () => {
  const location = useLocation();
  const { phoneNumber: initialPhoneNumber, openAddressModal } = location.state || { phoneNumber: '', openAddressModal: false };
    ...
    <div className='d-none d-lg-block'>
      ...
      >
        ...
        >
          ...
          <div style={{ marginBottom: '15px' }}>
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '8px' }}>
              <FaCreditCard style={{ marginRight: '8px', fontSize: '14px', color: '#666' }} />
              <span style={{ fontSize: '14px', color: '#666' }}>Payment Method</span>
            </div>
            <div
              style={{
                padding: '10px',
        ...
        >
          ...
          <div style={{ marginBottom: '10px', display: 'flex', justifyContent: 'space-between' }}>
            <span style={{ fontSize: '14px', color: '#333' }}>Item total</span>
            <span style={{ fontSize: '14px', color: '#333' }}>₹3,999</span>
          </div>
          <div style={{
            marginBottom: '10px',
            display: 'flex',
          ...
          <div style={{
            ...
            <span style={{ fontSize: '14px', color: '#333' }}>₹3,548</span>
          </div>
          <div style={{
            marginBottom: '10px',
            display: 'flex',
          ...
          >
            <span style={{ fontSize: '14px', color: '#333' }}>Advance Payment</span>
          ...
          <div style={{ textAlign: 'right' }}>
            <h4 style={{ fontSize: '14px', fontWeight: '600', color: '#333' }}>Amount to pay</h4>
            <p style={{ fontSize: '24px', fontWeight: 'bold', color: '#333', marginBottom: '5px' }}>
              ₹709
            </p>
            <a href="#" style={{ color: 'black', textDecoration: '', fontSize: '12px' }}>
              View breakup
            </a>
          </div>
        </div>
            ...
            <div style={{ marginBottom: '15px' }}>
              ...
              {paymentMethods.map((method, index) => (
                <div
                  ...
                  onClick={handleClosePaymentModal}
                >
                  <p style={{ fontSize: '14px', margin: '0', color: '#333' }}>{method.name}</p>
                </div>
              ))}
            </div>
          </div>
