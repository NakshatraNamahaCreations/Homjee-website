  ...
  const toggle = (index) => {
   ...
   const handleLocationSelected = (location) => {
    if (location === 'Current Location') {
      ...
      navigate('/checkoutcleaning', { state: { phoneNumber, openAddressModal: true } });
    }
  };
...
<div className="d-none d-lg-block">
  ...
  >
    <div style={{ textAlign: 'center', marginBottom: '30px' }}>
      <h2 style={{ fontSize: '28px', fontWeight: '600' }}>Choose Your Package</h2>
      <p style={{ fontSize: '16px', color: '#666' }}>Select the best package that suits your needs</p>
    </div>
    ...
    >
      {[
        { name: 'Basic', price: '₹999', features: ['1 Room Cleaning', '1 Bathroom', 'Dry Dusting'] },
        { name: 'Standard', price: '₹1999', features: ['2 BHK Cleaning', '2 Bathrooms', 'Wet & Dry Dusting'] },
        { name: 'Premium', price: '₹2999', features: ['3 BHK Full Cleaning', '3 Bathrooms', 'Deep Sanitization'] },
      ].map((pkg, index) => (
        <div
          key={index}
          style={{
        ...
        >
          <h4 style={{ fontWeight: '600', marginBottom: '10px' }}>{pkg.name}</h4>
          <h3 style={{ color: '#e60000', fontWeight: '700', marginBottom: '20px' }}>{pkg.price}</h3>
          <ul style={{ listStyle: 'none', padding: 0, marginBottom: '20px' }}>
            {pkg.features.map((f, i) => (
              <li key={i} style={{ marginBottom: '8px', fontSize: '14px' }}>{f}</li>
            ))}
          </ul>
          <Button
            style={{
...
<div className="d-block d-lg-none">
  ...
  >
    <div style={{ textAlign: 'center', marginBottom: '20px' }}>
      <h3 style={{ fontSize: '22px', fontWeight: '600' }}>Choose Your Package</h3>
      <p style={{ fontSize: '14px', color: '#777' }}>Select a plan that fits your need</p>
    </div>
    ...
    {[
      ...
      >
        <h4 style={{ fontWeight: '600', marginBottom: '8px' }}>{pkg.name}</h4>
        <h3 style={{ color: '#e60000', fontWeight: '700', marginBottom: '16px' }}>{pkg.price}</h3>
        <ul style={{ listStyle: 'none', padding: 0, marginBottom: '16px' }}>
          {pkg.features.map((f, i) => (
            <li key={i} style={{ marginBottom: '6px', fontSize: '13px' }}>{f}</li>
          ))}
        </ul>
        <Button
          style={{
