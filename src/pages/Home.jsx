  ...
  />
      ...
      >
        ...
        >
          ...
          <img
            src={arrow}
            alt="Arrow"
            style={{ height: "60px", width: "55px", marginTop: "-8%" }}
          />
        </div>
      ...
      <div className="d-none d-lg-block">
        ...
        >
          {/* LEFT SIDE CONTENT */}
          <div
            style={{ maxWidth: "500px", color: "#fff", position: "relative" }}
          >
            <p
              style={{
                fontFamily: "Fasthand",
          ...
          >
            <h3
              style={{ marginBottom: "20px", fontSize: "22px", color: "#000" }}
            >
              Get a call back
            </h3>
            <input
        ...
        >
          ...
          >
            <div style={{ textAlign: "center" }}>
              ...
              />
              <p style={{ fontSize: "10px", margin: "0", fontWeight: "600" }}>
                Best Quality
              </p>
            </div>
            <div style={{ textAlign: "center" }}>
...
`}</style>
      ...
      <div className="d-none d-lg-block">
        <div style={{ background: "#fff", padding: "60px 40px" }}>
          ...
          >
            Product <span style={{ color: "#000" }}>&</span>{" "}
            <span style={{ color: "#111" }}>Services</span>
            <img
              src={vectoricon}
              alt=""
              style={{
          ...
          >
            ...
            <Carousel
              ...
              nextIcon={
                <span className="carousel-control-next-icon custom-icon-painters" />
              }
              prevIcon={
                <span className="carousel-control-prev-icon custom-icon-painters" />
              }
            >
              <Carousel.Item>
                <div className="d-flex justify-content-between flex-wrap">
                  <div style={{ width: "32%", padding: "10px" }}>
                    ...
                    />
                    <h5 style={{ fontWeight: "700", marginTop: "15px" }}>
                      Interiors & exteriors
                    </h5>
                    <p style={{ fontSize: "14px", color: "#444" }}>
                      Color Your Home Inside Out
                    </p>
                  </div>
                  <div style={{ width: "32%", padding: "10px" }}>
                    <img
                    ...
                    <p style={{ fontSize: "14px", color: "#444" }}>
                      Elevate Your Style, Beyond The Ceiling, Beyond
                      Expectations
                    </p>
                  </div>
                  <div style={{ width: "32%", padding: "10px" }}>
                    ...
                    <p style={{ fontSize: "14px", color: "#444" }}>
                      Elevate Your Space With Wall Beautification
                    </p>
                  </div>
                </div>
              </Carousel.Item>
...
.carousel-control-next-icon.custom-icon-painters {
  background-color: #B45835;
      ...
      >
        {/* Section Heading */}
        <div
          style={{ marginBottom: "20px", textAlign: "", position: "relative" }}
        >
          <h2
            style={{
              fontSize: "28px",
      ...
      <div className="d-none d-lg-block">
        <div
          style={{ background: "#fff", padding: "60px 40px", marginTop: "-4%" }}
        >
          <div
            style={{
              background: "#e7f6ff",
          ...
          >
            ...
            <Carousel
              ...
              nextIcon={
                <span className="carousel-control-next-icon custom-icon-cleaning" />
              }
              prevIcon={
                <span className="carousel-control-prev-icon custom-icon-cleaning" />
              }
            >
              <Carousel.Item>
                <div className="d-flex justify-content-between flex-wrap">
                  <div style={{ width: "32%", padding: "10px" }}>
                    ...
                    <p style={{ fontSize: "14px", color: "#444" }}>
                      For A Home That Looks Brand New
                    </p>
                  </div>
                  <div style={{ width: "32%", padding: "10px" }}>
                    <img
                    ...
                    <p style={{ fontSize: "14px", color: "#444" }}>
                      Say Goodbye To Tough Oil & Grease
                    </p>
                  </div>
                  <div style={{ width: "32%", padding: "10px" }}>
                    <img
                    ...
                    <p style={{ fontSize: "14px", color: "#444" }}>
                      Hard Water Stains? Grout Grime? Gone!
                    </p>
                  </div>
                </div>
              </Carousel.Item>
        ...
        >
          ...
          >
            ...
            <Carousel
              ...
              nextIcon={
                <span className="carousel-control-next-icon custom-icon-interior" />
              }
              prevIcon={
                <span className="carousel-control-prev-icon custom-icon-interior" />
              }
            >
              <Carousel.Item>
                <div className="d-flex justify-content-between flex-wrap">
                  <div style={{ width: "32%", padding: "10px" }}>
                    ...
                    <p style={{ fontSize: "14px", color: "#444" }}>
                      Dream Home Design, Where Imagination Meets Reality
                    </p>
                  </div>
                  <div style={{ width: "32%", padding: "10px" }}>
                    <img
                    ...
                    <p style={{ fontSize: "14px", color: "#444" }}>
                      Smarter Kitchens, Where Functionality Meets Modern Design
                    </p>
                  </div>
                  <div style={{ width: "32%", padding: "10px" }}>
                    <img
                    ...
                    <p style={{ fontSize: "14px", color: "#444" }}>
                      Wake Up To Inspiration: Create A Bedroom That Energies You
                    </p>
                  </div>
                </div>
              </Carousel.Item>
              <Carousel.Item>
                <div className="d-flex justify-content-between flex-wrap">
                  <div style={{ width: "32%", padding: "10px" }}>
                    ...
                    <p style={{ fontSize: "14px", color: "#444" }}>
                      Spa-Like Serenity, Design Your Bathroom Oasis
                    </p>
                  </div>
                  <div style={{ width: "32%", padding: "10px" }}>
                    <img
              ...
              <Carousel.Item>
                <div className="d-flex justify-content-between flex-wrap">
                  <div style={{ width: "32%", padding: "10px" }}>
                    ...
                    <p style={{ fontSize: "14px", color: "#444" }}>
                      Rent the perfect truck for your smooth, efficient move
                    </p>
                  </div>
                  <div style={{ width: "32%", padding: "10px" }}>
                    <img
                    ...
                    <p style={{ fontSize: "14px", color: "#444" }}>
                      From packing to transport, we make shifting effortless and
                      worry-free
                    </p>
                  </div>
                  <div style={{ width: "32%", padding: "10px" }}>
                    ...
                    <p style={{ fontSize: "14px", color: "#444" }}>
                      Secure, flexible storage for your goods
                    </p>
                  </div>
                </div>
              </Carousel.Item>
              <Carousel.Item>
                <div className="d-flex justify-content-between flex-wrap">
                  <div style={{ width: "32%", padding: "10px" }}>
                    ...
                    <p style={{ fontSize: "14px", color: "#444" }}>
                      Our experts ensure safe, efficient loading and unloading
                      of all your items
                    </p>
                  </div>
                  <div style={{ width: "32%", padding: "10px" }}>
...
.carousel-control-next-icon.custom-icon-interior {
  background-color: #7E44AC;
      ...
      <div className="d-none d-lg-block">
        ...
        >
          ...
          >
            {["Painting", "Cleaning", "Shifting", "Interiors"].map(
              (item, idx) => (
                <button
                  key={idx}
                  ...
                  style={{
                    ...
                    border: "none",
                    backgroundColor:
                      activeCategory === item ? "red" : "#f1f1f1",
          ...
          >
            ...
            >
              {chunkArray(serviceSteps[activeCategory] || [], 3).map(
                (stepGroup, groupIndex) => (
                      ...
                      {stepGroup.map((step, stepIndex) => (
                        <React.Fragment key={stepIndex}>
                          ...
                          >
                            <img
                              src={
                                (stepIndex + groupIndex * 3) % 3 === 0
                                  ? step1
                                  : (stepIndex + groupIndex * 3) % 3 === 1
                                    ? step2
                                    : step3
                              }
  ...
  .carousel-control-next-icon.custom-icon {
    ...
    /> */}
      ...
      <div className="d-none d-lg-block">
        <div
          style={{ background: "#fff", padding: "60px 20px", marginTop: "-4%" }}
        >
          <div
            style={{
              background: "#f8f8f8",
            ...
            >
              {promises.map((item, index) => (
                ...
                >
                  ...
                  />
                  <p style={{ fontWeight: 700, whiteSpace: "pre-line" }}>
                    {item.title}
                  </p>
                </div>
              ))}
          ...
          {promises.map((item, index) => (
            ...
            >
              <img
                src={item.icon}
                alt={`Icon ${index + 1}`}
                style={{ height: "60px", marginBottom: "10px", width: "60px" }}
              />
              <p
                style={{
                  fontWeight: 700,
      ...
      >
        ...
        >
          <span style={{ color: "red", fontSize: "30px" }}>Hey!</span>{" "}
          <span role="img" aria-label="wave">
            👋
          </span>
        </h3>
      ...
      <div className="d-none d-lg-block">
        ...
        >
          ...
          <div style={{ maxWidth: "500px" }}>
            ...
            >
              Please Enter Your Name And WhatsApp Phone Number To Receive A Call
              Back From Us
            </p>
          </div>
      ...
      <div className="d-block d-lg-none" style={{ padding: "20px" }}>
        ...
        >
          ...
          <div>
            ...
            >
              Please Enter Your Name And WhatsApp <br />
              Phone Number To Receive A Call Back <br />
              From Us
            </p>
          </div>
