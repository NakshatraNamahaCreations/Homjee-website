...
const SlotSelectionModal = ({ show, onClose, onSelect }) => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <h3 style={{ fontSize: 18, fontWeight: 600, margin: 0, color: '#333' }}>
          ...
          {dates.map((dateObj, index) => (
            <button
              ...
              style={{
                ...
                height: 47,
                borderRadius: 8,
                border: selectedDate === dateObj.fullDate ? '2px solid #FF0000' : '1px solid #ccc',
                backgroundColor: selectedDate === dateObj.fullDate ? '#FF0000' : '#fff',
                cursor: 'pointer',
                fontWeight: 500,
            ...
            >
              {dateObj.day}<br />{dateObj.fullDate.split(', ')[1]} {/* Show day and date part */}
            </button>
          ))}
        </div>
        ...
        {/* Time Slot Selector */}
        <h4 style={{ fontSize: 16, fontWeight: 600, marginBottom: 10, color: '#333' }}>
          ...
          {timeSlots.map((time, index) => (
            <button
              ...
              style={{
                padding: 10,
                borderRadius: 6,
                border: selectedTimeSlot === time ? '2px solid #FF0000' : '1px solid #ccc',
...
window.location.reload()
            ...
            // };
            // onSelect(selectedSlot); // This triggers navigation in the parent
          }}
        >
          Proceed to checkout
        </button>
