...
import furnished_typesofcleaning from '../../../public/media/typesofcleaning.jpeg';
...
import furnished_includes from '/media/includes.jpeg';
...
const FurnishedApartmentModal = ({ pkgGroup, closeModal }) => {
  ...
  if (!pkgGroup) return null;

  // Extract the service name from the package group
  const serviceName = 'Furnished Apartment'; // Hardcoded for this modal, adjust dynamically if needed
      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: 'center', marginTop: '15px' }}>
            {[furnished_typesofcleaning, furnished_whatweclean, furnished_kitchen, furnished_bathroom, furnished_bolcany, furnished_floor, furnished_includes, furnished_Excludes, furnished_whatwedo].map((img, i) => (
              <img
                key={i}
                src={img}
                alt={`Visual ${i}`}
